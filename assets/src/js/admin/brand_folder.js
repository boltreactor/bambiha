                                            ...
                                            <div className="col s12 l12">
                                                <figure className="relative ma0">
                                                    ...
                                                    <div className="edit" style={{
                                                        ...
                                                        <button className="btn btn-icon btn-dark" style={{
                                                            borderRadius: '50%',
                                                            backgroundColor: '#343a408c',
                                                    ...
                                                    <figcaption className="img-caption left collapse">
                                                        ...
                                                        <button className="btn btn-dark btn-lg btn-pill mb3"
                                                                style={{width: '100px'}}>
                                                            SHOP
                                                        </button>
                                                    </figcaption>
                                                    ...
                                                    <div>
                                                        <div className="row">
                                                            <div className="col s12 m6 l6">
                                                                <label className="label-text bold">Tagline e.g. New
                                                                    Arrivals <i className="material-icons red"
                                  ...
                                  <span className="mdc-notched-outline">
                                    ...
                                    <span className="mdc-notched-outline__trailing"/>
                                                                    ...
                                                                    <input className="mdc-text-field__input" type="text"
                                                                           aria-label="Label"
                                                                           placeholder="Enter Tagline e.g. Be the bold self"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="mv2">
                                                        <label className="label-text bold">Select Category <i
                                  ...
                                  <option value="cat-4">Men</option>
                                        ...
                                        <div className="mb3">
                                            <div>
                                                <div className="row">
                                                    <div className="col s12 m6 l6">
                                                        <label className="label-text bold">Tagline e.g. New Arrivals <i
                                                            className="material-icons red"
                                                            style={{fontSize: '7px'}}>star</i>
                                                        </label>
                                                        <div
                                        ...
                                        <div className="row">
                                            <div className="col s12 l6 pr0-l">
                                                <figure className="relative ma0">
                                                    ...
                                                    {/* Image */}
                                                    <div className="img-wrapper l relative ma0 pa0 w-100">
                                                        <img className="w-100 h-100" src="/static/dumy-pics1.jpg"
                                                             alt=""/>
                                                    </div>
                                                    <figcaption className="img-caption left collapse">
                                                        <h1 className="bold white mb3">BE THE BOLD SELF</h1>
                                  ...
                                  <option value="cat-4">Men</option>
                                            ...
                                            <div className="col s12 l6 pl0-l">
                                                <figure className="relative ma0">
                                                    ...
                                                    {/* Image */}
                                                    <div className="img-wrapper l relative ma0 pa0 w-100">
                                                        <img className="w-100 h-100" src="/static/dumy-pics2.jpg"
                                                             alt=""/>
                                                    </div>
                                                    <figcaption className="img-caption left collapse">
                                                        <h1 className="bold white mb3">BE THE BOLD SELF</h1>
