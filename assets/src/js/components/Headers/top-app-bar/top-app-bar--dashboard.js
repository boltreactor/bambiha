      ...
      <header className="mdc-top-app-bar mdc-top-app-bar--fixed js-top-app-bar" data-mdc-auto-init="MDCTopAppBar">
        <div className="mdc-top-app-bar__row space-around__">
          <section className="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
            ...
            <Link to="/e-store/home" className="mdc-top-app-bar__title"><span className="tracked-m tracked-l">BAMBIHA</span></Link>
          </section>
                ...
                <div className="mdc-menu-surface--anchor">
                  <div className="mdc-menu mdc-menu-surface" tabIndex={0}>
                    <div className="content" style={{width: '15.25rem'}}>
                      <h4 className="dropdown-header dropdown-menu-item text-secondary" Link="#!">Bolt Reactor</h4>
                      ...
                      <Link className="dropdown-item dropdown-menu-item header_dropdown-item db link-mute" to="/e-store/dashboard">
                        <i className="material-icons-outlined v-mid">dashboard</i>
                        My Dashboard
                      </Link>
                      <Link className="dropdown-item dropdown-menu-item header_dropdown-item db link-mute" to="/orders">
