                ...
                <div className="mdc-menu-surface--anchor">
                  <div className="mdc-menu mdc-menu-surface" tabIndex={0}>
                    <div className="content" style={{width: '15.25rem'}}>
                      ...
                      <Link  className="dropdown-item dropdown-menu-item header_dropdown-item db link-mute" to="/log-in">
                        <i className="material-icons v-mid">account_box</i>
                        Sign In
                      </Link>
                      <Link className="dropdown-item dropdown-menu-item header_dropdown-item db link-mute" to="/sign-up">
