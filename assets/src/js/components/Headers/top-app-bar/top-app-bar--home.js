...
class TopAppBarHome extends Component {
    render() {
      ...
      <header className="mdc-top-app-bar mdc-top-app-bar--shadow__ mdc-top-app-bar--fixed js-top-app-bar" data-mdc-auto-init="MDCTopAppBar">
        {/* Primary top app bar */}
                ...
                <div className="mdc-menu-surface--anchor">
                  <div className="mdc-menu mdc-menu-surface" tabIndex={0}>
                    <div className="content" style={{width: '15.25rem'}}>
                      ...
                      <Link className="dropdown-item dropdown-menu-item header_dropdown-item db link-mute" to="/dashboard">
...
export default withRouter(TopAppBarHome);
