            ...
            <Fragment>
                <header className="mdc-top-app-bar mdc-top-app-bar--shadow" data-mdc-auto-init="MDCTopAppBar">
                    ...
                    <div className="mdc-top-app-bar__row">
                        <section className="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
                            <button
                                className="mdc-icon-button material-icons mdc-top-app-bar__navigation-icon--unbounded js-trigger-mdc-drawer"
                                onClick={() => {
                                    this.props.toggleDrawers(true)
                                }}>menu
                            </button>
                            <Link to="/" className="mdc-top-app-bar__title">
                                <span>Base</span><span>App</span>
                                {/*<span style={{color: '#9aa0a6', fontSize: '9px', fontWeight: 300, marginTop: '36px'}}>BETA</span>*/}
                            </Link>
                        </section>
                        <section className="mdc-top-app-bar__section mdc-top-app-bar__section--align-end get-started">
                            <div className="mh2">
                                <Link to="/login" className="mdc-top-app-bar__action-item link--mute text-muted"
                                      aria-label="Log in">Sign in</Link>
                            </div>
                            <div className="mh2">
                                <Link to="/signup" className="mdc-top-app-bar__action-item text-muted"
                                      aria-label="Sign up">
                                    <button className="mdc-button mdc-button--large mdc-button--unelevated"><span
