                        ...
                        <div className="row mb0">
                            ...
                            <div className="col s12 m4 l4 mb3">
                                        ...
                                        <div className="color-way__image-wrapper mb3 hide-scrollbar">
                                            <div className="list">
                                                <Link to="#" className="link-mute dib relative active">
                                                    <div className="relative">
                                                        <div className="mr2 mb1">
                                                            <img src="/static/show-1.jpeg" className="color-images"
                                                                 alt=""/>
                                                        </div>
                                                    </div>
                                                </Link>
                                                <Link to="#" className="link-mute dib relative">
                                                    <div className="relative">
                                                        <div className="mr2 mb1">
                                                            <img src="/static/img-noise.png" className="color-images"
                                                                 alt=""/>
                                                        </div>
                                                    </div>
                                                </Link>
                                ...
                                <div className="mv4 mh4-m mh4-l">
                                    <p className="m">
                                        The Nike Air Max 270 is our first-ever intentional lifestyle Air Max, delivering
                                        energy with every springy step. Updated with a varsity color combo and
                                        modernized comfort, it nods to the original 1991 Air Max 180 with its
                                        exaggerated tongue top and heritage-inspired tongue logo design.
                                    </p>
                                </div>
                            </div>
                        </div>
