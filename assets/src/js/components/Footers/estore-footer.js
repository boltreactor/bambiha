    ...
    render() {
        return (
            <div>
                        ...
                        <div className="default-footer__flex">
                            ...
                            <div className="default-footer__flex-box xs">
                                ...
                                <ul>
                                    ...
                                    <li className="truncate"><Link
                                        to="mailto:hello@boltreactor.com">hello@boltreactor.com</Link></li>
                ...
                <footer className=" pv5" style={{backgroundColor: '#051325'}}>
                    <div className="container xl">
                                ...
                                <div className="flex flex-wrap mv2">
                                    <div className="flex-grow-1">
                                        <div className="mdc-typography--label2 mr2 silver">
                                            <div className="mdc-typography--headline5 fw9 mb1"
                                    ...
                                    <div className="mt2">
                                        <div>
                                            <Link className="link hover-white silver dib h1 w1 mr3"
                                            ...
                                            <Link className="link hover-white silver dib h1 w1 mr3"
                                                  to="https://youtube.com" title="youtube">
                                                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                                                     viewBox="0 0 16 16" fillRule="evenodd" clipRule="evenodd"
                                                     strokeLinejoin="round" strokeMiterlimit="1.414">
                                                    <path
                                            ...
                                            <Link className="link silver hover-white dib h1 w1 mr3"
                                                  to="https://slack.com" title="Slack">
                                                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                                                     viewBox="0 0 16 16" fillRule="evenodd" clipRule="evenodd"
                                                     strokeLinejoin="round" strokeMiterlimit="1.414">
                                                    <g fillRule="nonzero">
                                                        <path
                                                            d="M6.586 7.33l.69 2.057 2.137-.716-.69-2.056-2.137.716z"/>
                                                        <path
                                            ...
                                            <Link className="link silver hover-white dib h1 w1 mr3"
                                                  to="https://medium.com/@mrmrs_/" title="Medium">
                                                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                                                     viewBox="0 0 16 16" fillRule="evenodd" clipRule="evenodd"
                                                     strokeLinejoin="round" strokeMiterlimit="1.414">
                                                    <path
                                            ...
                                            <Link className="link hover-white silver dib h1 w1 mr3"
                                                  to="https://linkedin.com" title="LinkedIn">
                                                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                                                     viewBox="0 0 16 16" fillRule="evenodd" clipRule="evenodd"
                                                     strokeLinejoin="round" strokeMiterlimit="1.414">
                                                    <path
                                            ...
                                            <Link className="link hover-white silver dib h1 w1 mr3"
                                                  to="https://twitter.com/mrmrs_" title="Twitter">
                                                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                                                     viewBox="0 0 16 16" fillRule="evenodd" clipRule="evenodd"
                                                     strokeLinejoin="round" strokeMiterlimit="1.414">
                                                    <path
                        ...
                        <div className="row">
                            ...
                            <div className="col s12 m4 tc-m tc-l">
                                <div className="mdc-typography--label2 silver mv2">
                                    Made with <i className="material-icons-outlined v-mid red"
                                                 style={{fontSize: '18px'}}>favorite</i> in Islamabad, Pakistan
                                </div>
                            </div>
                            <div className="col s12 m4 tr-m tr-l">
                                <div className="mdc-typography--label2 mv2">
                                    ...
                                    <Link to="#" className="link-mute silver hover-light-silver">Terms &
                                        Conditions</Link>
                                </div>
                            </div>
                        </div>
